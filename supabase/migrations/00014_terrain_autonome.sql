-- ============================================================
-- 00014 — Le commercial compose sa propre journée
--
-- Deux verrous à lever pour que le terrain soit autonome :
--
-- 1. LECTURE DES MAGASINS. `stores_read` (00001) limite encore la lecture au
--    périmètre d'attribution. Or le périmètre a été supprimé le 06/08 :
--    « tous les commerciaux peuvent traverser des magasins ». Résultat, un
--    commercial ne voit AUCUN magasin hors de sa tournée du jour — il ne peut
--    donc pas en ajouter un, ni signaler une urgence sur un magasin qu'il n'a
--    pas déjà au planning.
--
-- 2. URGENCE CRÉÉE DEUX FOIS. Le trigger de 00010 crée une visite d'urgence à
--    l'insertion de l'incident. Mais le terrain, lui, doit voir l'urgence
--    apparaître IMMÉDIATEMENT dans sa tournée, y compris hors ligne — donc
--    l'application crée la visite elle-même. Sans garde-fou, le trigger en
--    ajouterait une seconde à la synchronisation.
-- ============================================================
